...
namespace protobuf_sensor_5fdata_2eproto {
...
::google::protobuf::internal::SCCInfo<0> scc_info_SensorData =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsSensorData}, {}};
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "sensor_data.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\021sensor_data.proto\"\032\n\nSensorData\022\014\n\004dat"
      "a\030\001 \001(\002b\006proto3"
  };
...
SensorData::SensorData()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_sensor_5fdata_2eproto::scc_info_SensorData.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* SensorData::descriptor() {
  ::protobuf_sensor_5fdata_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_sensor_5fdata_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const SensorData& SensorData::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_sensor_5fdata_2eproto::scc_info_SensorData.base);
...
::google::protobuf::Metadata SensorData::GetMetadata() const {
  protobuf_sensor_5fdata_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_sensor_5fdata_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::SensorData* Arena::CreateMaybeMessage< ::SensorData >(Arena* arena) {
